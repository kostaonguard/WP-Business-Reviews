...
$config = array(
	...
	'sections' => array(
		array(
			'id'          => 'platforms',
			'name'        => __( 'Platform Settings', 'wp-business-reviews' ),
			'description' => sprintf(
		...
		array(
			'id'          => 'google_places',
			'name'        => __( 'Google Reviews Settings', 'wp-business-reviews' ),
			'description' => sprintf(
				/* translators: link to documentation */
		...
		array(
			'id'          => 'facebook',
			'name'        => __( 'Facebook Reviews Settings', 'wp-business-reviews' ),
			'description' => sprintf(
				/* translators: link to documentation */
		...
		array(
			'id'          => 'yelp',
			'name'        => __( 'Yelp Reviews Settings', 'wp-business-reviews' ),
			'description' => sprintf(
				/* translators: link to documentation */
		...
		array(
			'id'          => 'yp',
			'name'        => __( 'YP Reviews Settings', 'wp-business-reviews' ),
			'description' => sprintf(
				/* translators: link to documentation */
		...
		array(
			'id'          => 'advanced',
			'name'        => __( 'Advanced Settings', 'wp-business-reviews' ),
			'description' => sprintf(
				/* translators: link to documentation */
