...
<div class="wpbr-field wpbr-field--text<?php echo ! empty( $class ) ? ' ' . esc_attr( $class ) : ''; ?>">
	<label class="wpbr-field__name" for="<?php echo esc_attr( $att_id ); ?>"><?php echo esc_html( $field['name'] ); ?></label>
	<input class="wpbr-field__control regular-text" id="<?php echo esc_attr( $att_id ); ?>" type="password"
